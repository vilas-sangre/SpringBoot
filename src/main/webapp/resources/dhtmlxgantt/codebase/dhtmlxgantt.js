...
*/! function (t) {
	...
	t.exports = function (t) {
		t.locale = {
			...
			labels: {
				...
				icon_delete: "Delete",
				confirm_closing: "",
				confirm_deleting: "Record will be deleted permanently, are you sure?",
	...
	t.exports = function (t) {
		...
		return n(r, e), r.prototype.render = function (e) {
			...
			return n += i, e.single_date ? (i = t.form_blocks.getTimePicker.call(this, e, !0), n += "<span></span>") : n += "<span style='font-weight:normal; font-size:10pt;'>  –  </span>", n += i, n += "</div>"
		}, r.prototype.set_value = function (e, i, n, r) {
			var a = r,
