 	...
 	return newTime;
		...
		/** Default settings for the plugin.
			...
			@property [maxTime=null] {Date|number|string} The latest selectable time, or <code>null</code> for no limit.
						See <code>defaultTime</code> for possible formats.
			@property [spinnerImage='resources/images/spinnerDefault.png'] {string} The URL of the images to use for the time spinner -
		...
		defaultOptions: {
			...
			minTime: null,
			maxTime: null,
			spinnerImage: 'resources/images/spinnerDefault.png',
			spinnerSize: [20, 20, 8],
			spinnerBigImage: '',
