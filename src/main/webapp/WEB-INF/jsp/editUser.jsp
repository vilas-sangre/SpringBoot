                ...
                <div class="content-wrapper">
                    ...
                    <section class="content">
                        <div class="row">
                           ...
                           <form:form method="post" action="updateUser" name="frm" id="frm"  enctype="multipart/form-data" commandName="user">
...
<form:input path="id" id="id" type='number' class="form-control onlyNumberWithOutDecimal"  readonly="readonly"  />
