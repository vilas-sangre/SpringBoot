                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="resultAnalysisList"> <i class="fa fa-list"></i>  <spring:message code="resultAnalysis.heading"/> List(<span style="color:red;">${seatNoErrorMessage}</span>) </a>  
                                        </div>
                                    </div>
                                    <div class="panel-body">
                           
                           
                           <form:form method="post" action="updateResultAnalysisBySeatNo" name="frm" id="frm"  enctype="multipart/form-data" commandName="resultAnalysis">
...
<form:input path="created_date" id="created_date" type='text' class="form-control dateControl"  readonly="true"  />
<form:errors path="created_date" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.created_user"/></label>
<form:input path="created_user" id="created_user"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
<form:errors path="created_user" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subect1_name"/></label>
<form:input path="subect1_name" id="subect1_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject11" id="subject11" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject11" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject12"/></label>
<form:input path="subject12" id="subject12" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject12" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject13"/></label>
<form:input path="subject13" id="subject13" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject13" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject2_name"/></label>
<form:input path="subject2_name" id="subject2_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject21" id="subject21" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject21" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject22"/></label>
<form:input path="subject22" id="subject22" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject22" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject23"/></label>
<form:input path="subject23" id="subject23" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject3_name" id="subject3_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject31" id="subject31" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject31" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject32"/></label>
<form:input path="subject32" id="subject32" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject32" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject33"/></label>
<form:input path="subject33" id="subject33" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject4_name" id="subject4_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject41" id="subject41" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject41" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject42"/></label>
<form:input path="subject42" id="subject42" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject42" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject43"/></label>
<form:input path="subject43" id="subject43" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject5_name" id="subject5_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject51" id="subject51" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject51" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject52"/></label>
<form:input path="subject52" id="subject52" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject52" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject53"/></label>
<form:input path="subject53" id="subject53" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject6_name" id="subject6_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject61" id="subject61" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject61" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject62"/></label>
<form:input path="subject62" id="subject62" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject62" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject63"/></label>
<form:input path="subject63" id="subject63" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject7_name" id="subject7_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject71" id="subject71" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject71" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject72"/></label>
<form:input path="subject72" id="subject72" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject72" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject73"/></label>
<form:input path="subject73" id="subject73" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject8_name" id="subject8_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject81" id="subject81" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject81" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject82"/></label>
<form:input path="subject82" id="subject82" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject82" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject83"/></label>
<form:input path="subject83" id="subject83" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject9_name" id="subject9_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject91" id="subject91" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject91" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject92"/></label>
<form:input path="subject92" id="subject92" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject92" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject93"/></label>
<form:input path="subject93" id="subject93" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="subject10_name" id="subject10_name"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
...
<form:input path="subject101" id="subject101" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject101" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject102"/></label>
<form:input path="subject102" id="subject102" type='text' class="form-control" maxlength="10" readonly="true"   />
<form:errors path="subject102" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.subject103"/></label>
<form:input path="subject103" id="subject103" type='text' class="form-control" maxlength="10" readonly="true"   />
...
<form:input path="sgpi" id="sgpi"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
<form:errors path="sgpi" cssStyle="color:red"></form:errors> 
</div>

 <div class="col-sm-3 form-group">
<label><spring:message code="resultAnalysis.cgpi"/></label>
<form:input path="cgpi" id="cgpi"  class="form-control textAreaClass"  maxlength="200" readonly="true" />
