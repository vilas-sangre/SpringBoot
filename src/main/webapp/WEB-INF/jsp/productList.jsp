...
<head>
   ...
   <!--preloader-->
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonexport">
                              <a href="#">
                                 <h4><spring:message code="product.heading"/></h4>
                              </a>
                           </div>
                        </div>
	...
	<thead>
		<tr>
			<th class="heading"><spring:message code="product.productname"/></th>
			<th class="heading"><spring:message code="product.description"/></th>
